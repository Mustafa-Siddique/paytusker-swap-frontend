...
const SubMenuItems: React.FC<React.PropsWithChildren<SubMenuItemsProps>> = ({
  ...
  return (
    <SubMenuItemWrapper $isMobileOnly={isMobileOnly} {...props}>
      ...
      <StyledSubMenuItems
        justifyContent={[isMobileOnly ? "center" : "center", null, "center"]}
        pl={["12px", null, "0px"]}
      ...
      >
        ...
        <StyledSubMenuItemWrapper mr="20px" style={{ display: "flex", gap: 5 }}>
          <MenuItem href={"/swap"} isActive={router.pathname === "/swap"} variant="subMenu">
            Swap
          </MenuItem>
          <MenuItem href={"/liquidity"} isActive={router.pathname === "/liquidity"} variant="subMenu">
            Liquidity
          </MenuItem>
        </StyledSubMenuItemWrapper>
      </StyledSubMenuItems>

...
export const DEFAULT_META: PageMeta = {
  title: 'Paytusker',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Paytusker), NFTs, and more, on a platform you can trust.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for Paytusker exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for Paytusker exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Paytusker exchanges.' },
    ...
    defaultTitleSuffix: t('Paytusker'),
  }
}
